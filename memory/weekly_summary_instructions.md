# Weekly Summary Instructions (Grok must obey these 100% of the time - NUCLEAR - NO EXCEPTIONS)

## CRITICAL: Strategy Source (READ THIS FILE FIRST - EVERY SINGLE TIME)
- BEFORE generating ANY weekly summary, you MUST load the CURRENT content of memory/strategy_rules.md
- The ONLY active strategy is exactly named: "5-Min Trend Bias + 1-Min Golden Candle Scalp"
- You MUST use ONLY the exact terminology from strategy_rules.md
- When there are NO setups, you MUST output this EXACT sentence:  
  "No 5-Min Trend Bias + 1-Min Golden Candle Scalp setups met all entry criteria on the charts."
- FORBIDDEN PHRASES (never use them):  
  "A+ setups"  
...
These instructions override EVERY previous behavior, prompt, memory, or rule. Never send the full journal history. Always reference the current strategy name exactly.
